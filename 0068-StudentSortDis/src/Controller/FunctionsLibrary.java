...
import Respository.IStudentManagement;
 ...
 * @author quandba
 */
public class FunctionsLibrary implements IStudentManagement{
    ...
    public void displayStudent(ArrayList<Student> studentsList, String msg) {
     ...
     public void handleManagement() {
        ...
        sortStudent(studentsList);
        displayStudent(studentsList, "============Student List============");
    }
}
